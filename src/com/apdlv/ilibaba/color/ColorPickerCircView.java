...
public class ColorPickerCircView extends View 
{
    ...
    public ColorPickerCircView(Context context, AttributeSet attrs) 
    {
	super(context, attrs);
	init();
    }

    public ColorPickerCircView(Context context, AttributeSet attrs, int defStyle) 
    {	
        super(context, attrs, defStyle);
        init();
    }

    public ColorPickerCircView(Context c) 
    {
	super(c);
	init();
    }
